...
// 赖子做将：合肥红中规则，2 赖子或 1 真牌+1 赖子 都可做将
ok('2 张赖子做将 = 胡', MJ.win([
  T.w(1), T.w(1), T.w(1),
  T.w(2), T.w(2), T.w(2),
  T.w(3), T.w(3), T.w(3),
...
// 1 真牌 + 1 赖子 做将（用户实战遇到的场景：8筒+中 做将）
ok('1真牌+1赖子 做将 = 胡', MJ.win([
  T.w(1), T.w(1), T.w(1),
  T.w(2), T.w(2), T.w(2),
  T.w(3), T.w(3), T.w(3),
  T.w(4), T.w(4), T.w(4),
...
// 用户实战牌型：5条6条+中+中+8筒（3碰副露）—— 中当7条凑顺子，8筒+中 做将
ok('实战牌型：56条+2中+8筒+3碰 = 胡', MJ.win([
  T.s(5), T.s(6), T.z, T.z, T.p(8),
], 3) === true);
